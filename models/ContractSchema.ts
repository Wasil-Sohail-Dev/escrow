...
const isValidContractStatusTransition = (currentStatus: keyof typeof contractStatusTransitions, newStatus: string): boolean => {
...
contractSchema.methods.updateStatus = async function (newStatus: string, subStatus = null) {
