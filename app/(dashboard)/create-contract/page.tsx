...
const CreateContract = () => {
  ...
  const allMilestonesValid = formData.milestones.every(milestone => 
    milestone.name && milestone.amount && milestone.startDate && milestone.endDate
  );
      ...
      <div className="mt-[85px]">
          ...
          <form className="space-y-6">
                ...
                {["services", "products"].map((type) => (
                  <div key={type} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={() => handleInputChange("contractType", type)}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-20">
              ...
              <div className="space-y-2">
                ...
                {vendorEmailError && (
                  <p className="text-sm text-red-500 mt-1">{vendorEmailError}</p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`h-[48px] lg:h-[52px] dark:bg-dark-input-bg border ${
                  fieldErrors.title ? "border-red-500 focus-visible:ring-red-500" : "border-[#D1D5DB]"
            ...
            {contractDateError && (
                <div className="col-span-full">
                  <p className="text-sm text-red-500 -mt-4">{contractDateError}</p>
                </div>
              )}
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                className={`min-h-[120px] dark:bg-dark-input-bg border ${
                  fieldErrors.description ? "border-red-500 focus-visible:ring-red-500" : "border-[#E8EAEE]"
                } dark:border-dark-border rounded-lg text-[16px] lg:text-[16px] font-[400] leading-[19.5px] text-[#292929] dark:text-dark-text placeholder:text-[#ABB1BB] dark:placeholder:text-dark-text/40`}
              />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-20">
              <div className="space-y-2 flex-1">
                ...
                <Input
                  ...
                  className={`h-[48px] lg:h-[52px] dark:bg-dark-input-bg border ${
                    fieldErrors.totalPayment ? "border-red-500 focus-visible:ring-red-500" : "border-[#D1D5DB]"
                  } dark:border-dark-border rounded-lg text-[16px] lg:text-[16px] font-[400] leading-[19.5px] text-[#292929] dark:text-dark-text placeholder:text-[#ABB1BB] dark:placeholder:text-dark-text/40`}
                />
                {fieldErrors.totalPayment && (
                  <p className="text-sm text-red-500 mt-1">{fieldErrors.totalPayment}</p>
                )}
                {paymentError && (
              ...
              {formData.totalPayment && !isNaN(parseFloat(formData.totalPayment)) && (
                <div className="space-y-2 flex-1">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <h2 className={`text-body-medium ${allMilestonesValid ? "text-primary" : "text-gray-500"} text-[15px] flex items-center`}>
                  <Plus className="mr-2" /> Add New Milestone
                </h2>
              </TooltipTrigger>
              <TooltipContent>{allMilestonesValid ? "Add Milestone" : "Please fill all the milestone fields"}</TooltipContent>
            </Tooltip>
                ...
                <div key={index} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-20">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className={`h-[48px] lg:h-[52px] dark:bg-dark-input-bg border ${
                          milestoneErrors[index]?.name ? "border-red-500 focus-visible:ring-red-500" : "border-[#D1D5DB]"
                        } dark:border-dark-border rounded-lg text-[16px] lg:text-[16px] font-[400] leading-[19.5px] text-[#292929] dark:text-dark-text placeholder:text-[#ABB1BB] dark:placeholder:text-dark-text/40`}
                      />
                      {milestoneErrors[index]?.name && (
                        <p className="text-sm text-red-500 mt-1">{milestoneErrors[index].name}</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onWheel={(e) => e.currentTarget.blur()}
                        className={`h-[48px] lg:h-[52px] dark:bg-dark-input-bg border ${
                          milestoneErrors[index]?.amount ? "border-red-500 focus-visible:ring-red-500" : "border-[#D1D5DB]"
                        } dark:border-dark-border rounded-lg text-[16px] lg:text-[16px] font-[400] leading-[19.5px] text-[#292929] dark:text-dark-text placeholder:text-[#ABB1BB] dark:placeholder:text-dark-text/40`}
                      />
                      {milestoneErrors[index]?.amount && (
                        <p className="text-sm text-red-500 mt-1">{milestoneErrors[index].amount}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      className={`min-h-[120px] dark:bg-dark-input-bg border ${
                        milestoneErrors[index]?.description ? "border-red-500 focus-visible:ring-red-500" : "border-[#E8EAEE]"
                      } dark:border-dark-border rounded-lg text-[16px] lg:text-[16px] font-[400] leading-[19.5px] text-[#292929] dark:text-dark-text placeholder:text-[#ABB1BB] dark:placeholder:text-dark-text/40`}
                    />
                    {milestoneErrors[index]?.description && (
                      <p className="text-sm text-red-500 mt-1">{milestoneErrors[index].description}</p>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-20">
                    <div className="space-y-2 flex flex-col">
                      ...
                      <DatePicker
                        selected={milestone.startDate ? new Date(milestone.startDate + "T00:00:00") : null}
                        onChange={(date: Date | null) => {
                          if (date) {
                            const formattedDate = date.toISOString().split('T')[0];
                            handleMilestoneChange(index, "startDate", formattedDate);
                          }
                        }}
                        dateFormat="MM/dd/yyyy"
                        placeholderText="Select start date"
                    ...
                    <div className="space-y-2 flex flex-col">
                      ...
                      <DatePicker
                        selected={milestone.endDate ? new Date(milestone.endDate + "T00:00:00") : null}
                        onChange={(date: Date | null) => {
                          if (date) {
                            const formattedDate = date.toISOString().split('T')[0];
                            handleMilestoneChange(index, "endDate", formattedDate);
                          }
                        }}
                        dateFormat="MM/dd/yyyy"
                        placeholderText="Select end date"
                  ...
                  {milestoneDateErrors[index] && (
                      <div className="col-span-full">
                        <p className="text-sm text-red-500 -mt-4">{milestoneDateErrors[index]}</p>
                      </div>
                    )}
                </div>
              ))}
            ...
            <div className="space-y-1">
              ...
              <p className="text-[14px] text-gray-500 dark:text-dark-text/60">
                Upload vendor's contract documents, agreements, or any relevant paperwork (Optional)
              </p>
              <DragDropFile
        ...
        <div className="flex flex-col sm:flex-row justify-end items-center gap-4 pt-6">
          <Button
            ...
            disabled={!formData.title || !formData.description || !formData.totalPayment}
          >
            Preview
          </Button>
          <Button
            ...
            disabled={isLoading || !formData.title || !formData.description || !formData.totalPayment}
          >
            {isLoading ? (
