        ...
        <div className="w-full">
          ...
          <div className="">
            {notifications.map((notification) => (
              <div
                key={notification.id}
                className="flex items-start gap-4 py-4 border-b border-[#E8EAEE] dark:border-dark-border hover:bg-white-2 dark:hover:bg-dark-input-bg transition-colors cursor-pointer"
              >
                <div
