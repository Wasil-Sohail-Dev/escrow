      ...
      <ModalContent className="w-[95%] max-w-[400px] px-4 md:px-6 rounded-lg">
        <ModalHeader>
          <ModalTitle className="text-[16px] sm:text-[20px] md:text-[20px] font-[600] dark:text-dark-text border-b border-[#E3E3E3] pb-4">
            Confirm {isBlocking ? 'Block' : 'Unblock'}
          </ModalTitle>
        </ModalHeader>
        <div className="space-y-4 mt-5">
          ...
          <div className="text-center space-y-2">
            <p className="text-[14px] sm:text-[15px] md:text-[16px] text-paragraph dark:text-dark-text">
              Are you sure you want to {isBlocking ? 'block' : 'unblock'} this customer?
            </p>
            <p className="text-[12px] sm:text-[13px] md:text-[14px] text-paragraph/60 dark:text-dark-text/60">
              {isBlocking 
                ...
                : 'This will restore the customer\'s access to the platform'
              }
            </p>
          </div>
            ...
            <Button
              ...
              className={`${
                isBlocking 
                  ...
                  : 'bg-success-btn hover:bg-success-btn-hover'
              } text-white dark:text-dark-text text-[12px] sm:text-[13px] md:text-[14px] font-[600] leading-[16px] h-[36px] sm:h-[38px] md:h-[42px] rounded-lg flex items-center gap-2`}
            >
              {processing ? (
                <>
