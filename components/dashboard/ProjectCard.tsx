...
export default function ProjectCard({
  ...
  return (
    <div
      className="bg-[#DADADA33] p-4 rounded-lg shadow-sm flex-1 text-center 
      lg:w-auto max-md:w-full max-md:flex-none"
    >
      <div className="flex flex-col gap-1">
        <h3
          className={`text-heading4-medium ${
            dispute ? " dark:text-dark-text" : statusColors[status]
          } 
        ...
        <p
          className="text-heading3-bold lg:text-heading3-bold 
          md:text-heading4-medium max-md:text-heading4-medium dark:text-dark-text"
        >
          {count}
        </p>
        <Link
